...
** link:../ROOT/{attachmentsdir}/aws-infra-docs/TED-SWS-Installation-manual-v2.6.1.pdf[AWS installation manual (v2.6.1)^]
** link:../ROOT/{attachmentsdir}/aws-infra-docs/TED-SWS-AWS-Infrastructure-architecture-overview-v0.9.pdf[AWS infrastructure architecture (v0.9)^]
